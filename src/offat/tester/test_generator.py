...
class TestGenerator:
    ...
    def bopla_fuzz_test(
        ...
        for path_obj in request_response_params:
            ...
            response_body_params = self._inject_response_params(path_obj.get('response_params',[]))
            ...
            tasks.append({
                ...
                'query_params':request_query_params,
                'path_params':path_params,
                'malicious_payload':response_body_params, # TODO: check these params in response
                'args': args,
                'kwargs': kwargs,
                'result_details':{
